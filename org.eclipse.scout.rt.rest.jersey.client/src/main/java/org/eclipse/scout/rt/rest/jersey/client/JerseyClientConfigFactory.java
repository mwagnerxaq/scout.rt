...
public class JerseyClientConfigFactory implements IRestClientConfigFactory {
  ...
  protected void initConnectionProvider(ClientConfig clientConfig) {
    if (Boolean.TRUE.toString().equals(clientConfig.getProperty(RestClientProperties.USE_SCOUT_APACHE_CONNECTOR)) || CONFIG.getPropertyValue(UseScoutApacheConnectorProperty.class)) {
